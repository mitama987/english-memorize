...
export function SparklesIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 3l1.91 4.36L18.5 9l-4.59 1.64L12 15l-1.91-4.36L5.5 9l4.59-1.64L12 3z" />
      <path d="M19 14l.96 2.18L22 17l-2.04.82L19 20l-.96-2.18L16 17l2.04-.82L19 14z" />
    </svg>
  );
}
